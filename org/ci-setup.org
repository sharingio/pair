...
#+begin_quote
Maintainance set up for the main pair.sharing.io CI pipeline
#+end_quote
...
#+RESULTS:
#+begin_example
role.rbac.authorization.k8s.io/sharingio-pair-ci unchanged
rolebinding.rbac.authorization.k8s.io/sharingio-pair-ci unchanged
#+end_example
...
Secret name: sharingio-pair-ci-token-xwqsh

Extracting ca.crt from secret...done
Getting user token from secret...done
Setting current context to: sharingio-admin@sharingio
Cluster name: sharingio
 Endpoint: https://139.178.91.101:6443

Preparing k8s-sharingio-pair-ci-sharingio-pair-conf
Setting a cluster entry in kubeconfig...Cluster "sharingio" set.
Setting token credentials entry in kubeconfig...User "sharingio-pair-ci-sharingio-pair-sharingio" set.
Setting a context entry in kubeconfig...Context "sharingio-pair-ci-sharingio-pair-sharingio" created.
Setting the current-context in the kubeconfig file...Switched to context "sharingio-pair-ci-sharingio-pair-sharingio".
